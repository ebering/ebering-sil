...
extern bool cruel_blow(monster_type *mptr, monster_race *rptr, int net_dam, int crit_bonus_dice);
...
extern void do_cmd_launch(int quiver);
extern void do_cmd_fire(int quiver);
extern void do_cmd_throw(int quiver);

/* cmd3.c */
extern void do_cmd_use_item(void);
extern void do_cmd_inven(void);
extern void do_cmd_equip(void);
extern void do_cmd_wield(object_type *default_o_ptr, int default_item, bool alt_slot);
